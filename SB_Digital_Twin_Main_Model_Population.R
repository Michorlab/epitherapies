...
# Optional: inspect the first few patients
head(pk_AKTi_params_samples)
...
define_PK_EZHi_fun <- function(D0_e, dose_times, total_time, times_between_doses, pk_params) {
  ...
  for (dose_time in dose_times) {
    ...
    current_state_first[1] <- current_state_first[1] + D0_e[iijjii]*0.33 
...
tested_treatments <- tested_treatments[1:4032, ]
...
# # ## General study
# #
selected_schedule_indices <- c(4037, 4038, 4035, 4041,  3295, 224, 203) #_2
#
...
# # # AKTi study
# 
# selected_schedule_indices_AKTi_study  <- c(4035, 4041, 4046, 4047, 4048, 4049) #_2
...
# # # # EZH2i study
#
# selected_schedule_indices_EZH2i_study  <- c(4040, 4041, 4042, 4043, 4044, 4045) #_2
...
# # Main study - DISCREET
# schedule_info_file <- "/Users/.../main_study_discreet_schedule_info.rds"
# 
# waterfall_data_file <- "/Users/.../main_study_discreet_waterfall_data.rds"
...
ggplot(boxplot_df,
  ...
  scale_fill_viridis_d(option = "plasma", begin = 0.05, end = 0.9) +
  # scale_fill_brewer(
  #   palette = "Greens",   # light → dark green (EZH2i study)
...
sched_ids <- c(4037, 4038, 4035, 4041,  3295, 224, 203) #_2
